...
2) The MySQL script given at this GitHub location must be run, so that the required schema and the table has been created before running this RMD File: https://github.com/deepakmongia/Fall2018/blob/master/Data%20607%20Final%20Project/Data%20607%20Final%20Project%20-%20Twitter%20MySQL%20Queries.sql
...
create_token("607 Final Project",
            consumer_key = "gHstONqMeOBv1rt5RDeuMgUik",
             consumer_secret = "nm4D79aZpCRKFnfdAUq5AUsKw6FhN10Nl4BWgQykq9CIWHd0Ho",
             access_token = "1061784425728483328-mcQS7h4cQrt8s0GB1kCjPp8aGda3Kt",
             access_secret = "AzoleHP9GDlmV5bTmg3wvYUWvUYuZ2V8myiqukm6hAHoK")
...
###2. Storing the data (tweet text) into MySQL table.
...
### 2. As there are so many users / people interested in the brand, there have been many advertizements going around to woo customers by so many third party online companies.
### 3. With such hype around a product by a company like Apple, many people voice their views and opinions online. And Twitter being one of the most used social networking portal, it gave a good deal of tweets to analyze the customer sentiment.
### 4. Even if there is not a single conclusion from this analysis we found some good information about the overall sentiments around iPhone XS which can be seen in the plots and points shown in this document.