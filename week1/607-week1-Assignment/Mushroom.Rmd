...
Loading the data from the data file(agaricus-lepiota.data)

```{r Loading_Data}
agaricus.lepiota <- read.csv("~/CunyMSDS/agaricus-lepiota.data")
```
...
Tranforming data using sapply function. Below code transform the abbreviation into a meaningfull name. Try using apply function so that the transaformation on all columns is done once. 
